...
def score_display(game_state):
    if game_state == "main_game":
        score_surface = game_font.render(str(int(score)), True, (255, 255, 0))    # Red, Green, Blue 255,255,255
...
pygame.time.set_timer(SPAWNPIPE, 1500)   # 1200
pipe_height = [400, 600, 800]  # 400, 600, 800
